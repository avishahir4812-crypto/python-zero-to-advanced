...
#     print(balance)
# elif(choice==2):
#     diposite = int(input("deposite yout amount:"))
...
buying = float(input("Enter your buying amount: "))
choice = int(input("Enter your type: "))

if choice == 1:
    total = buying - (buying * 0.10)
    print("Student Discount Applied (10%)")

elif choice == 2:
    total = buying - (buying * 0.05)
    print("Regular Discount Applied (5%)")

elif choice == 3:
    total = buying - (buying * 0.20)
    print("Premium Discount Applied (20%)")

else:
    print("Invalid Choice")
    exit()

# Extra 5% discount if purchase is above ₹10,000
if buying > 10000:
    total = total - (total * 0.05)
    print("Extra 5% Discount Applied")
