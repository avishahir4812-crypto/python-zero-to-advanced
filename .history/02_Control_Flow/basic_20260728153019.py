...
buying =(int(input("enter your buing amount:")))
...
if(choice==1):
   total= print("your discount is:",student)
elif(choice==2):
   total= print("your discount is:",regular)
elif(choice==3):
    total= print("your discount is:",premium)
else:
   print("invaild choice")

if(buying>10000):
   total = total - (total*0.5)
   print("you get extra descount")
